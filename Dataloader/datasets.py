...
def dataset(args, datanames):
    ...
    CIFARFS_train_loader = BatchMetaDataLoader(CIFARFS_train_dataset, batch_size=args.batch_size,
        shuffle=True, pin_memory=True, num_workers=args.num_workers)
    ...
    Plantae_train_loader = BatchMetaDataLoader(Plantae_train_dataset, batch_size=args.batch_size,
        shuffle=True, pin_memory=True, num_workers=args.num_workers)
    ...
    Fungi_train_loader = BatchMetaDataLoader(Fungi_train_dataset, batch_size=args.batch_size,
        shuffle=True, pin_memory=True, num_workers=args.num_workers)
    ...
    transform = None
    Necessities_folder = 'Logo/Processed/Necessities'
    ...
    transform = None
    Electronic_folder = 'Logo/Processed/Electronic'
    ...
    Electronic_train_loader = BatchMetaDataLoader(Electronic_train_dataset, batch_size=args.batch_size,
        shuffle=True, pin_memory=True, num_workers=args.num_workers)
