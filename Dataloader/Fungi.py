...
class Fungi(CombinationMetaDataset):
    ...
    def __init__(self, root, num_classes_per_task=None, meta_train=False,
        ...
        dataset = FungiClassDataset(root, meta_train=meta_train, meta_val=meta_val,
            meta_test=meta_test, meta_split=meta_split, transform=transform,
            class_augmentations=class_augmentations, download=download)
        super(Fungi, self).__init__(dataset, num_classes_per_task,
...
class FungiClassDataset(ClassDataset):
    ...
    def __init__(self, root, meta_train=False, meta_val=False, meta_test=False,
                 ...
                 download=False):
        super(FungiClassDataset, self).__init__(meta_train=meta_train,
    ...
    def __getitem__(self, index):
        ...
        return FungiDataset(index, data, label, transform=transform,
...
class FungiDataset(Dataset):
    def __init__(self, index, data, label,
        ...
        super(FungiDataset, self).__init__(index, transform=transform,
                                         target_transform=target_transform)
        self.data = data
        self.label = label
